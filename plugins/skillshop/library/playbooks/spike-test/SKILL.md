---
name: spike-test
description: "Validate system behavior, amplification and recovery when traffic increases abruptly beyond normal steady-state assumptions. Use when traffic spike, flash crowd, burst testing."
license: MIT
...
- Primary mission: Validate system behavior, amplification and recovery when traffic increases abruptly beyond normal steady-state assumptions.
...
- A result that directly satisfies: Validate system behavior, amplification and recovery when traffic increases abruptly beyond normal steady-state assumptions.
