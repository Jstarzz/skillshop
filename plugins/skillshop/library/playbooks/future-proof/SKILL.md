---
name: future-proof
description: "Preserve extension points only where future change is credible, expensive to retrofit and cheap to accommodate now. Use when known roadmap growth, hard-to-migrate boundary, counterweight to caveman."
license: MIT
...
- known roadmap growth
- hard-to-migrate boundary
- counterweight to caveman

## Focus

- Primary mission: Preserve extension points only where future change is credible, expensive to retrofit and cheap to accommodate now.
...
- A result that directly satisfies: Preserve extension points only where future change is credible, expensive to retrofit and cheap to accommodate now.
