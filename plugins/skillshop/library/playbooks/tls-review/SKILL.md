---
name: tls-review
description: "Review TLS termination, certificate lifecycle, protocol policy, proxy trust and mixed-content/redirect behavior. Use when TLS, certificate, HTTPS."
license: MIT
...
- Primary mission: Review TLS termination, certificate lifecycle, protocol policy, proxy trust and mixed-content/redirect behavior.
...
- A result that directly satisfies: Review TLS termination, certificate lifecycle, protocol policy, proxy trust and mixed-content/redirect behavior.
