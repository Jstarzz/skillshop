---
name: background-location-review
description: "Review background location tracking for platform constraints, permission UX, battery, batching, offline buffering and recovery. Use when background GPS, location tracking, Android tracking."
license: MIT
...
- Primary mission: Review background location tracking for platform constraints, permission UX, battery, batching, offline buffering and recovery.
...
- A result that directly satisfies: Review background location tracking for platform constraints, permission UX, battery, batching, offline buffering and recovery.
