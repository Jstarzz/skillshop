---
name: refactor
description: "Improve internal structure while preserving externally observable behavior and limiting migration risk. Use when refactor, reduce coupling, cleanup without behavior change."
license: MIT
...
- Primary mission: Improve internal structure while preserving externally observable behavior and limiting migration risk.
...
- A result that directly satisfies: Improve internal structure while preserving externally observable behavior and limiting migration risk.
