---
name: background-jobs-review
description: "Review queued and scheduled jobs for identity, retries, leases, idempotency, cancellation and operability. Use when background job, cron worker, queue consumer."
license: MIT
...
- Primary mission: Review queued and scheduled jobs for identity, retries, leases, idempotency, cancellation and operability.
...
- A result that directly satisfies: Review queued and scheduled jobs for identity, retries, leases, idempotency, cancellation and operability.
