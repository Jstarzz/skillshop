...
description: "Use short red-green-refactor cycles when behavior is known and executable tests can define correctness first. Use when TDD, test-first, regression bug fix."
license: MIT
...
- Primary mission: Use short red-green-refactor cycles when behavior is known and executable tests can define correctness first.
...
- A result that directly satisfies: Use short red-green-refactor cycles when behavior is known and executable tests can define correctness first.
