...
description: "Ensure retried or duplicated commands do not create duplicate side effects or corrupt state. Use when idempotency, duplicate request, at-least-once."
license: MIT
...
- Primary mission: Ensure retried or duplicated commands do not create duplicate side effects or corrupt state.
...
- A result that directly satisfies: Ensure retried or duplicated commands do not create duplicate side effects or corrupt state.
