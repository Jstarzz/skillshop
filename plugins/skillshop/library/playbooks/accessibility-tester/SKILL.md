...
description: "Test keyboard, semantics, focus, forms, names, contrast, zoom and assistive-technology behavior as product functionality. Use when accessibility QA, keyboard testing, screen reader concerns."
license: MIT
...
- Primary mission: Test keyboard, semantics, focus, forms, names, contrast, zoom and assistive-technology behavior as product functionality.
...
- A result that directly satisfies: Test keyboard, semantics, focus, forms, names, contrast, zoom and assistive-technology behavior as product functionality.
