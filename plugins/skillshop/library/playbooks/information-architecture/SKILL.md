...
description: "Organize navigation and content around user tasks and domain concepts so features are discoverable without memorizing the system. Use when navigation redesign, feature sprawl, findability."
license: MIT
...
- Primary mission: Organize navigation and content around user tasks and domain concepts so features are discoverable without memorizing the system.
...
- A result that directly satisfies: Organize navigation and content around user tasks and domain concepts so features are discoverable without memorizing the system.
