---
name: form-ux
description: "Make forms understandable, fast, recoverable and accessible while reducing unnecessary input and validation friction. Use when form UX, checkout form, signup form."
license: MIT
...
- Primary mission: Make forms understandable, fast, recoverable and accessible while reducing unnecessary input and validation friction.
...
- A result that directly satisfies: Make forms understandable, fast, recoverable and accessible while reducing unnecessary input and validation friction.
