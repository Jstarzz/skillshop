...
description: "Review ingestion and ETL pipelines for schema drift, idempotency, late data, retries, backfills, lineage and observability. Use when ETL, data ingestion, pipeline backfill."
license: MIT
...
- Primary mission: Review ingestion and ETL pipelines for schema drift, idempotency, late data, retries, backfills, lineage and observability.
...
- A result that directly satisfies: Review ingestion and ETL pipelines for schema drift, idempotency, late data, retries, backfills, lineage and observability.
