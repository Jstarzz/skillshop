---
name: config-review
description: "Review runtime configuration for unsafe defaults, drift, missing validation, secret confusion and production footguns. Use when environment variables, config drift, unsafe defaults."
license: MIT
...
- Primary mission: Review runtime configuration for unsafe defaults, drift, missing validation, secret confusion and production footguns.
...
- A result that directly satisfies: Review runtime configuration for unsafe defaults, drift, missing validation, secret confusion and production footguns.
