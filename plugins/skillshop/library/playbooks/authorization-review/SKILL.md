...
description: "Verify sensitive operations enforce server-side permissions at resource boundaries and resist horizontal and vertical escalation. Use when RBAC, IDOR, permission review."
license: MIT
...
- Primary mission: Verify sensitive operations enforce server-side permissions at resource boundaries and resist horizontal and vertical escalation.
...
- A result that directly satisfies: Verify sensitive operations enforce server-side permissions at resource boundaries and resist horizontal and vertical escalation.
