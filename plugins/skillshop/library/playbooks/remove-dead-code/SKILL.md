...
description: "Delete unused code, dependencies, routes, styles and flags only after proving they are not part of active or dynamic behavior. Use when dead code, deprecated feature, unused dependency."
license: MIT
...
- Primary mission: Delete unused code, dependencies, routes, styles and flags only after proving they are not part of active or dynamic behavior.
...
- A result that directly satisfies: Delete unused code, dependencies, routes, styles and flags only after proving they are not part of active or dynamic behavior.
