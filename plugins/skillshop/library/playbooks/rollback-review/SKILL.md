...
description: "Prove a release can be reverted or forward-fixed safely, including schema compatibility and irreversible side effects. Use when rollback plan, risky release, database deploy."
license: MIT
...
- Primary mission: Prove a release can be reverted or forward-fixed safely, including schema compatibility and irreversible side effects.
...
- A result that directly satisfies: Prove a release can be reverted or forward-fixed safely, including schema compatibility and irreversible side effects.
