---
name: paranoid
description: "Assume dependencies, operators, networks and processes fail and expose the hidden assumptions most likely to hurt production. Use when reliability review, critical workflow, failure assumptions."
license: MIT
...
- Primary mission: Assume dependencies, operators, networks and processes fail and expose the hidden assumptions most likely to hurt production.
...
- A result that directly satisfies: Assume dependencies, operators, networks and processes fail and expose the hidden assumptions most likely to hurt production.
