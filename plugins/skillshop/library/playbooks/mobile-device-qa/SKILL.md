...
description: "Test mobile experiences across realistic screens, touch input, keyboards, orientation, lifecycle and constrained devices. Use when mobile QA, Android iOS, device matrix."
license: MIT
...
- Primary mission: Test mobile experiences across realistic screens, touch input, keyboards, orientation, lifecycle and constrained devices.
...
- A result that directly satisfies: Test mobile experiences across realistic screens, touch input, keyboards, orientation, lifecycle and constrained devices.
