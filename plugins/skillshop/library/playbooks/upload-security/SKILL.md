...
description: "Review uploads for size, path, content, storage, rendering, archive and malware risks. Use when file upload, image upload, archive import."
license: MIT
...
- Primary mission: Review uploads for size, path, content, storage, rendering, archive and malware risks.
...
- A result that directly satisfies: Review uploads for size, path, content, storage, rendering, archive and malware risks.
