---
name: time-zone-review
description: "Review temporal modeling for instants, local dates, wall times, DST, recurring schedules and API serialization. Use when timezone, DST, scheduling."
license: MIT
...
- Primary mission: Review temporal modeling for instants, local dates, wall times, DST, recurring schedules and API serialization.
...
- A result that directly satisfies: Review temporal modeling for instants, local dates, wall times, DST, recurring schedules and API serialization.
