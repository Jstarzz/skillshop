...
description: "Design concise manual test cases where human judgment, hardware or low-frequency workflows make automation a poor fit. Use when manual QA, hardware test, acceptance test."
license: MIT
...
- Primary mission: Design concise manual test cases where human judgment, hardware or low-frequency workflows make automation a poor fit.
...
- A result that directly satisfies: Design concise manual test cases where human judgment, hardware or low-frequency workflows make automation a poor fit.
