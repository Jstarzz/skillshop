...
description: "Review maintainability and clarity after correctness risks, focusing on future change cost rather than stylistic preference. Use when maintainability review, complex module, cleanup pass."
license: MIT
...
- Primary mission: Review maintainability and clarity after correctness risks, focusing on future change cost rather than stylistic preference.
...
- A result that directly satisfies: Review maintainability and clarity after correctness risks, focusing on future change cost rather than stylistic preference.
