---
name: query-hunter
description: "Find N+1, duplicate, unbounded and badly shaped database access from actual application paths. Use when N+1, too many queries, ORM performance."
license: MIT
...
- Primary mission: Find N+1, duplicate, unbounded and badly shaped database access from actual application paths.
...
- A result that directly satisfies: Find N+1, duplicate, unbounded and badly shaped database access from actual application paths.
