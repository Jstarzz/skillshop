---
name: api-consumer
description: "Review an API strictly from the integrating client's perspective for predictability, low round trips and usable contracts. Use when API DX, integration pain, public API review."
license: MIT
...
- Primary mission: Review an API strictly from the integrating client's perspective for predictability, low round trips and usable contracts.
...
- A result that directly satisfies: Review an API strictly from the integrating client's perspective for predictability, low round trips and usable contracts.
