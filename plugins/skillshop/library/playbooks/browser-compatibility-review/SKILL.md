...
description: "Review web code for APIs, CSS and behaviors likely to differ across supported browsers before cross-browser execution. Use when browser compatibility, new web API, CSS support."
license: MIT
...
- Primary mission: Review web code for APIs, CSS and behaviors likely to differ across supported browsers before cross-browser execution.
...
- A result that directly satisfies: Review web code for APIs, CSS and behaviors likely to differ across supported browsers before cross-browser execution.
