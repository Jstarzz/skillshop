---
name: grandma
description: "Evaluate whether a nontechnical first-time user can understand and complete the primary task using only visible cues. Use when usability review, first-time user, confusing UI."
license: MIT
...
- Primary mission: Evaluate whether a nontechnical first-time user can understand and complete the primary task using only visible cues.
...
- A result that directly satisfies: Evaluate whether a nontechnical first-time user can understand and complete the primary task using only visible cues.
