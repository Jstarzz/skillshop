...
description: "Update developer and operator documentation to match actual changed behavior, configuration, contracts and commands. Use when docs stale, API/config changed, setup changed."
license: MIT
...
- Primary mission: Update developer and operator documentation to match actual changed behavior, configuration, contracts and commands.
...
- A result that directly satisfies: Update developer and operator documentation to match actual changed behavior, configuration, contracts and commands.
