...
description: "Improve user-visible frontend responsiveness by measuring network, bundle, main-thread, rendering and interaction costs on representative devices. Use when slow frontend, bundle size, janky UI."
license: MIT
...
- Primary mission: Improve user-visible frontend responsiveness by measuring network, bundle, main-thread, rendering and interaction costs on representative devices.
...
- A result that directly satisfies: Improve user-visible frontend responsiveness by measuring network, bundle, main-thread, rendering and interaction costs on representative devices.
