...
description: "Review event and message schemas for ownership, versioning, idempotency, ordering and consumer compatibility. Use when event schema, message contract, event bus."
license: MIT
...
- Primary mission: Review event and message schemas for ownership, versioning, idempotency, ordering and consumer compatibility.
...
- A result that directly satisfies: Review event and message schemas for ownership, versioning, idempotency, ordering and consumer compatibility.
