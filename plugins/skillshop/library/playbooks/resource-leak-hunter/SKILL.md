...
description: "Find memory, goroutine/thread, file descriptor, connection, timer and subscription leaks under repeated or sustained workloads. Use when memory leak, connection leak, resource growth."
license: MIT
...
- Primary mission: Find memory, goroutine/thread, file descriptor, connection, timer and subscription leaks under repeated or sustained workloads.
...
- A result that directly satisfies: Find memory, goroutine/thread, file descriptor, connection, timer and subscription leaks under repeated or sustained workloads.
