---
name: session-review
description: "Review session and token lifecycle for fixation, theft, storage, expiry, rotation, revocation and concurrent-device behavior. Use when session cookies, JWT, refresh token."
license: MIT
...
- Primary mission: Review session and token lifecycle for fixation, theft, storage, expiry, rotation, revocation and concurrent-device behavior.
...
- A result that directly satisfies: Review session and token lifecycle for fixation, theft, storage, expiry, rotation, revocation and concurrent-device behavior.
