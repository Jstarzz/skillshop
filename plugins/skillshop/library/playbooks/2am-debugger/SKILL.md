---
name: 2am-debugger
description: "Judge whether a tired on-call engineer can identify impact, recent changes and likely root cause quickly using documented tooling. Use when runbook review, on-call readiness, 2am debug."
license: MIT
...
- Primary mission: Judge whether a tired on-call engineer can identify impact, recent changes and likely root cause quickly using documented tooling.
...
- A result that directly satisfies: Judge whether a tired on-call engineer can identify impact, recent changes and likely root cause quickly using documented tooling.
