---
name: test-architect
description: "Design the overall test portfolio and CI tiers so confidence comes from complementary layers rather than maximum test count. Use when test strategy, slow flaky suite, coverage gaps."
license: MIT
...
- Primary mission: Design the overall test portfolio and CI tiers so confidence comes from complementary layers rather than maximum test count.
...
- A result that directly satisfies: Design the overall test portfolio and CI tiers so confidence comes from complementary layers rather than maximum test count.
