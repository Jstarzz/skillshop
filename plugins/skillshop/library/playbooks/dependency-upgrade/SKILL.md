...
description: "Upgrade dependencies with controlled scope, release-note awareness, compatibility testing and rollback clarity. Use when dependency bump, framework upgrade, security update."
license: MIT
...
- Primary mission: Upgrade dependencies with controlled scope, release-note awareness, compatibility testing and rollback clarity.
...
- A result that directly satisfies: Upgrade dependencies with controlled scope, release-note awareness, compatibility testing and rollback clarity.
