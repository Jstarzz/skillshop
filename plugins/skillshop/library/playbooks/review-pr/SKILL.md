---
name: review-pr
description: "Review a pull request for correctness, regressions, security, performance, maintainability and missing verification. Use when PR review, pre-merge audit, diff review."
license: MIT
...
- Primary mission: Review a pull request for correctness, regressions, security, performance, maintainability and missing verification.
...
- A result that directly satisfies: Review a pull request for correctness, regressions, security, performance, maintainability and missing verification.
