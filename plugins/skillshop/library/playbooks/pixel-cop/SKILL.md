---
name: pixel-cop
description: "Review visual consistency in typography, spacing, hierarchy, tokens, alignment, icons, radius and responsive states. Use when UI polish, design drift, visual consistency."
license: MIT
...
- Primary mission: Review visual consistency in typography, spacing, hierarchy, tokens, alignment, icons, radius and responsive states.
...
- A result that directly satisfies: Review visual consistency in typography, spacing, hierarchy, tokens, alignment, icons, radius and responsive states.
