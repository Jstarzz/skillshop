...
description: "Inject bounded failures to verify timeouts, retries, degradation, recovery and state integrity rather than trusting design claims. Use when chaos test, failover test, dependency failure injection."
license: MIT
...
- Primary mission: Inject bounded failures to verify timeouts, retries, degradation, recovery and state integrity rather than trusting design claims.
...
- A result that directly satisfies: Inject bounded failures to verify timeouts, retries, degradation, recovery and state integrity rather than trusting design claims.
