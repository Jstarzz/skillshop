---
name: secrets-review
description: "Prevent credentials and sensitive keys from leaking through source, history, logs, client bundles, CI artifacts or container layers. Use when secret handling, credential leak, new API key."
license: MIT
...
- Primary mission: Prevent credentials and sensitive keys from leaking through source, history, logs, client bundles, CI artifacts or container layers.
...
- A result that directly satisfies: Prevent credentials and sensitive keys from leaking through source, history, logs, client bundles, CI artifacts or container layers.
