...
description: "Review multi-step writes for atomicity, isolation, external side effects and ambiguous commit outcomes. Use when transaction boundary, partial write, financial workflow."
license: MIT
...
- Primary mission: Review multi-step writes for atomicity, isolation, external side effects and ambiguous commit outcomes.
...
- A result that directly satisfies: Review multi-step writes for atomicity, isolation, external side effects and ambiguous commit outcomes.
