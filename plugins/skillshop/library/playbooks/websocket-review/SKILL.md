...
description: "Review WebSocket and SSE behavior for auth, ordering, reconnect, replay, slow consumers and backpressure. Use when WebSocket, SSE, realtime updates."
license: MIT
...
- Primary mission: Review WebSocket and SSE behavior for auth, ordering, reconnect, replay, slow consumers and backpressure.
...
- A result that directly satisfies: Review WebSocket and SSE behavior for auth, ordering, reconnect, replay, slow consumers and backpressure.
