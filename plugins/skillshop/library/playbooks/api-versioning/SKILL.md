---
name: api-versioning
description: "Design API evolution and deprecation so clients can migrate without surprise breakage or permanent version sprawl. Use when API versioning, breaking API change, deprecation."
license: MIT
...
- Primary mission: Design API evolution and deprecation so clients can migrate without surprise breakage or permanent version sprawl.
...
- A result that directly satisfies: Design API evolution and deprecation so clients can migrate without surprise breakage or permanent version sprawl.
