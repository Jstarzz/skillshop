---
name: dependency-hater
description: "Challenge dependencies whose value does not justify supply-chain, upgrade, bundle or operational cost. Use when too many dependencies, large package for small feature, dependency audit."
license: MIT
...
- large package for small feature
- dependency audit

## Focus

- Primary mission: Challenge dependencies whose value does not justify supply-chain, upgrade, bundle or operational cost.
...
- A result that directly satisfies: Challenge dependencies whose value does not justify supply-chain, upgrade, bundle or operational cost.
