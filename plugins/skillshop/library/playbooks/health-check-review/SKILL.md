...
description: "Ensure liveness, readiness and startup probes represent actionable process state without causing cascades. Use when health check, Kubernetes probe, readiness issues."
license: MIT
...
- Primary mission: Ensure liveness, readiness and startup probes represent actionable process state without causing cascades.
...
- A result that directly satisfies: Ensure liveness, readiness and startup probes represent actionable process state without causing cascades.
