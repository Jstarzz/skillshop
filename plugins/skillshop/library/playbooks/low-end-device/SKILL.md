---
name: low-end-device
description: "Test and design for constrained CPU, memory, GPU and network so the product stays usable beyond flagship hardware. Use when low-end Android, constrained device, mobile performance."
license: MIT
...
- Primary mission: Test and design for constrained CPU, memory, GPU and network so the product stays usable beyond flagship hardware.
...
- A result that directly satisfies: Test and design for constrained CPU, memory, GPU and network so the product stays usable beyond flagship hardware.
