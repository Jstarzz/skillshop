---
name: privacy-review
description: "Review personal and sensitive data collection, exposure, logging, sharing, retention and deletion with minimization as the default. Use when PII, privacy, data collection."
license: MIT
...
- Primary mission: Review personal and sensitive data collection, exposure, logging, sharing, retention and deletion with minimization as the default.
...
- A result that directly satisfies: Review personal and sensitive data collection, exposure, logging, sharing, retention and deletion with minimization as the default.
