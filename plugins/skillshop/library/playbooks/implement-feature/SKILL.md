...
description: "Implement a defined feature as the smallest coherent vertical slice while preserving project conventions and proving behavior. Use when build feature, acceptance criteria exist, production code change."
license: MIT
...
- Primary mission: Implement a defined feature as the smallest coherent vertical slice while preserving project conventions and proving behavior.
...
- A result that directly satisfies: Implement a defined feature as the smallest coherent vertical slice while preserving project conventions and proving behavior.
