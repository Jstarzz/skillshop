...
description: "Change old fragile systems safely using characterization, seams and incremental replacement instead of reckless rewrites. Use when legacy code, old framework, fragile subsystem."
license: MIT
...
- Primary mission: Change old fragile systems safely using characterization, seams and incremental replacement instead of reckless rewrites.
...
- A result that directly satisfies: Change old fragile systems safely using characterization, seams and incremental replacement instead of reckless rewrites.
