---
name: mobile-native-feasibility
description: "Determine whether a mobile requirement belongs in web, PWA, cross-platform native or platform-native code based on APIs and performance. Use when mobile architecture, React Native Flutter native, device API."
license: MIT
...
- Primary mission: Determine whether a mobile requirement belongs in web, PWA, cross-platform native or platform-native code based on APIs and performance.
...
- A result that directly satisfies: Determine whether a mobile requirement belongs in web, PWA, cross-platform native or platform-native code based on APIs and performance.
