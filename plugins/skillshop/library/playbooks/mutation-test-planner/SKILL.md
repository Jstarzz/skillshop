...
description: "Use targeted mutation testing to find important behavior that existing tests execute but fail to protect. Use when mutation testing, high coverage low confidence, test effectiveness."
license: MIT
...
- Primary mission: Use targeted mutation testing to find important behavior that existing tests execute but fail to protect.
...
- A result that directly satisfies: Use targeted mutation testing to find important behavior that existing tests execute but fail to protect.
