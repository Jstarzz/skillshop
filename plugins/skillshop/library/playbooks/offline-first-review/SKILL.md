...
description: "Review offline-capable workflows for local state, sync ownership, conflict resolution, retries and user-visible freshness. Use when offline first, sync, field app."
license: MIT
...
- Primary mission: Review offline-capable workflows for local state, sync ownership, conflict resolution, retries and user-visible freshness.
...
- A result that directly satisfies: Review offline-capable workflows for local state, sync ownership, conflict resolution, retries and user-visible freshness.
