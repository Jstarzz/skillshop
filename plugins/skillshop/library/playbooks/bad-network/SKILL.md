---
name: bad-network
description: "Evaluate behavior under latency, jitter, bandwidth limits, connection resets, offline transitions and reconnects. Use when bad network, offline testing, mobile connectivity."
license: MIT
...
- Primary mission: Evaluate behavior under latency, jitter, bandwidth limits, connection resets, offline transitions and reconnects.
...
- A result that directly satisfies: Evaluate behavior under latency, jitter, bandwidth limits, connection resets, offline transitions and reconnects.
