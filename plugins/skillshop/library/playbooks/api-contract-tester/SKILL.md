...
description: "Verify API status, schema, validation, errors, auth differences and backwards-compatibility behavior from a consumer perspective. Use when API test, contract test, schema drift."
license: MIT
...
- Primary mission: Verify API status, schema, validation, errors, auth differences and backwards-compatibility behavior from a consumer perspective.
...
- A result that directly satisfies: Verify API status, schema, validation, errors, auth differences and backwards-compatibility behavior from a consumer perspective.
