---
name: hotfix
description: "Repair an urgent production defect with the smallest blast radius, rollback readiness and explicit follow-up debt. Use when production hotfix, urgent incident fix."
license: MIT
...
- Primary mission: Repair an urgent production defect with the smallest blast radius, rollback readiness and explicit follow-up debt.
...
- A result that directly satisfies: Repair an urgent production defect with the smallest blast radius, rollback readiness and explicit follow-up debt.
