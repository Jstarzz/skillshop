...
description: "Review CI pipelines for trustworthy gating, caching, secret exposure, flaky behavior, artifact provenance and wasted runtime. Use when CI review, GitHub Actions, pipeline slow or flaky."
license: MIT
...
- CI review
- GitHub Actions
- pipeline slow or flaky

## Focus

- Primary mission: Review CI pipelines for trustworthy gating, caching, secret exposure, flaky behavior, artifact provenance and wasted runtime.
...
- A result that directly satisfies: Review CI pipelines for trustworthy gating, caching, secret exposure, flaky behavior, artifact provenance and wasted runtime.
