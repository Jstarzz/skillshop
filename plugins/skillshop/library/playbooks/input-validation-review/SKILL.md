...
description: "Review untrusted input validation, canonicalization, limits and dangerous sinks at real trust boundaries. Use when input validation, injection, parser security."
license: MIT
...
- Primary mission: Review untrusted input validation, canonicalization, limits and dangerous sinks at real trust boundaries.
...
- A result that directly satisfies: Review untrusted input validation, canonicalization, limits and dangerous sinks at real trust boundaries.
