---
name: auth-review
description: "Review authentication, reset, MFA, lockout and federation flows for bypass, enumeration and credential weaknesses. Use when login change, password reset, OAuth OIDC."
license: MIT
...
- Primary mission: Review authentication, reset, MFA, lockout and federation flows for bypass, enumeration and credential weaknesses.
...
- A result that directly satisfies: Review authentication, reset, MFA, lockout and federation flows for bypass, enumeration and credential weaknesses.
