---
name: race-hunter
description: "Find concurrency defects by forcing unsafe interleavings, duplicate operations and shared-state races. Use when race condition, intermittent concurrency bug, parallel writes."
license: MIT
...
- Primary mission: Find concurrency defects by forcing unsafe interleavings, duplicate operations and shared-state races.
...
- A result that directly satisfies: Find concurrency defects by forcing unsafe interleavings, duplicate operations and shared-state races.
