---
name: queue-pressure
description: "Review queues under bursty producers, slow consumers, poison messages, retries and backlog growth. Use when queue backlog, worker pressure, poison message."
license: MIT
...
- Primary mission: Review queues under bursty producers, slow consumers, poison messages, retries and backlog growth.
...
- A result that directly satisfies: Review queues under bursty producers, slow consumers, poison messages, retries and backlog growth.
