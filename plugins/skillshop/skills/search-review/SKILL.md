---
name: search-review
description: "Review search for relevance, indexing lag, tenant/access boundaries, broad-query behavior and safe degradation. Use when search feature, full text search, search index."
license: MIT
...
- Primary mission: Review search for relevance, indexing lag, tenant/access boundaries, broad-query behavior and safe degradation.
...
- A result that directly satisfies: Review search for relevance, indexing lag, tenant/access boundaries, broad-query behavior and safe degradation.
