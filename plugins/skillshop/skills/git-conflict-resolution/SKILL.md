...
description: "Resolve merge and rebase conflicts semantically by reconstructing both sides' intended behavior. Use when merge conflict, rebase conflict, branch integration."
license: MIT
...
- Primary mission: Resolve merge and rebase conflicts semantically by reconstructing both sides' intended behavior.
...
- A result that directly satisfies: Resolve merge and rebase conflicts semantically by reconstructing both sides' intended behavior.
