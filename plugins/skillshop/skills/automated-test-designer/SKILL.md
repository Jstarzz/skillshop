---
name: automated-test-designer
description: "Choose and design automated tests at the lowest reliable layer while minimizing brittleness, duplication and runtime. Use when add regression tests, test suite design, new behavior."
license: MIT
...
- Primary mission: Choose and design automated tests at the lowest reliable layer while minimizing brittleness, duplication and runtime.
...
- A result that directly satisfies: Choose and design automated tests at the lowest reliable layer while minimizing brittleness, duplication and runtime.
