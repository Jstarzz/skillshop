---
name: openapi-review
description: "Review OpenAPI descriptions for runtime accuracy, generator friendliness, auth/error completeness and compatibility. Use when OpenAPI, Swagger, client generation."
license: MIT
...
- Primary mission: Review OpenAPI descriptions for runtime accuracy, generator friendliness, auth/error completeness and compatibility.
...
- A result that directly satisfies: Review OpenAPI descriptions for runtime accuracy, generator friendliness, auth/error completeness and compatibility.
