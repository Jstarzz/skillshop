...
description: "Review deployment flow for artifact immutability, environment promotion, migrations, health gates, rollback and drift. Use when deployment pipeline, staging to production, deploy review."
license: MIT
...
- Primary mission: Review deployment flow for artifact immutability, environment promotion, migrations, health gates, rollback and drift.
...
- A result that directly satisfies: Review deployment flow for artifact immutability, environment promotion, migrations, health gates, rollback and drift.
