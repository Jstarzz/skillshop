---
name: no-mouse
description: "Verify important web functionality is usable keyboard-only with sensible focus order, visible focus and control semantics. Use when keyboard only, accessibility, focus order."
license: MIT
...
- Primary mission: Verify important web functionality is usable keyboard-only with sensible focus order, visible focus and control semantics.
...
- A result that directly satisfies: Verify important web functionality is usable keyboard-only with sensible focus order, visible focus and control semantics.
