...
description: "Compare performance runs fairly and identify operationally meaningful regressions while accounting for environment and variance. Use when performance regression, before after benchmark, CI perf gate."
license: MIT
...
- Primary mission: Compare performance runs fairly and identify operationally meaningful regressions while accounting for environment and variance.
...
- A result that directly satisfies: Compare performance runs fairly and identify operationally meaningful regressions while accounting for environment and variance.
