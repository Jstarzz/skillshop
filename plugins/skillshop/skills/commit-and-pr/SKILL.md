---
name: commit-and-pr
description: "Turn a finished working tree into reviewable commits and a truthful pull request with verification evidence. Use when prepare PR, clean commits, PR description."
license: MIT
...
- Primary mission: Turn a finished working tree into reviewable commits and a truthful pull request with verification evidence.
...
- A result that directly satisfies: Turn a finished working tree into reviewable commits and a truthful pull request with verification evidence.
