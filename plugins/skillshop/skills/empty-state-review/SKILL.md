---
name: empty-state-review
description: "Design first-use, no-results and zero-data states that explain context and offer the next meaningful action without decorative filler. Use when empty state, no results, first-use UI."
license: MIT
...
- Primary mission: Design first-use, no-results and zero-data states that explain context and offer the next meaningful action without decorative filler.
...
- A result that directly satisfies: Design first-use, no-results and zero-data states that explain context and offer the next meaningful action without decorative filler.
