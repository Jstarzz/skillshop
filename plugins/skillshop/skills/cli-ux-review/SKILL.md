---
name: cli-ux-review
description: "Review command-line interfaces for discoverability, composability, stable exit/output contracts and safe defaults. Use when CLI design, developer tool UX, command interface."
license: MIT
...
- Primary mission: Review command-line interfaces for discoverability, composability, stable exit/output contracts and safe defaults.
...
- A result that directly satisfies: Review command-line interfaces for discoverability, composability, stable exit/output contracts and safe defaults.
