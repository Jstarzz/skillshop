---
name: reverse-proxy-review
description: "Review reverse-proxy configuration for routing, headers, timeouts, buffering, TLS, websocket behavior and safe reloads. Use when Caddy, Nginx, reverse proxy."
license: MIT
...
- Primary mission: Review reverse-proxy configuration for routing, headers, timeouts, buffering, TLS, websocket behavior and safe reloads.
...
- A result that directly satisfies: Review reverse-proxy configuration for routing, headers, timeouts, buffering, TLS, websocket behavior and safe reloads.
