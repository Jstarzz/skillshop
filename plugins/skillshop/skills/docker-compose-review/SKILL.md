...
description: "Review Compose stacks for dependency readiness, durable state, networks, volumes, health, local-prod drift and operability. Use when Docker Compose, local stack, compose production."
license: MIT
...
- Primary mission: Review Compose stacks for dependency readiness, durable state, networks, volumes, health, local-prod drift and operability.
...
- A result that directly satisfies: Review Compose stacks for dependency readiness, durable state, networks, volumes, health, local-prod drift and operability.
