---
name: logging-review
description: "Review logging for stable structure, useful context, privacy, noise and ingestion cost. Use when logging review, noisy logs, incident context."
license: MIT
...
- Primary mission: Review logging for stable structure, useful context, privacy, noise and ingestion cost.
...
- A result that directly satisfies: Review logging for stable structure, useful context, privacy, noise and ingestion cost.
