---
name: profiler
description: "Find where CPU, latency, allocations, I/O or contention are actually spent before optimizing. Use when profile slow code, CPU high, latency investigation."
license: MIT
...
- Primary mission: Find where CPU, latency, allocations, I/O or contention are actually spent before optimizing.
...
- A result that directly satisfies: Find where CPU, latency, allocations, I/O or contention are actually spent before optimizing.
