---
name: speed-demon
description: "Aggressively optimize measured hot paths after correctness is established while keeping overhead and complexity accountable. Use when hot path optimization, latency critical, throughput optimization."
license: MIT
...
- Primary mission: Aggressively optimize measured hot paths after correctness is established while keeping overhead and complexity accountable.
...
- A result that directly satisfies: Aggressively optimize measured hot paths after correctness is established while keeping overhead and complexity accountable.
