...
description: "Review and test behavior when downstream services become slow, malformed, partially available or completely unavailable. Use when third-party outage, downstream failure, dependency resilience."
license: MIT
...
- Primary mission: Review and test behavior when downstream services become slow, malformed, partially available or completely unavailable.
...
- A result that directly satisfies: Review and test behavior when downstream services become slow, malformed, partially available or completely unavailable.
