...
description: "Review feature flags for ownership, targeting, rollout, rollback, test matrix, interactions and cleanup. Use when feature flag, gradual rollout, flag debt."
license: MIT
...
- Primary mission: Review feature flags for ownership, targeting, rollout, rollback, test matrix, interactions and cleanup.
...
- A result that directly satisfies: Review feature flags for ownership, targeting, rollout, rollback, test matrix, interactions and cleanup.
