...
description: "Determine whether a proposed capability is buildable within platform, integration, performance, schedule and maintenance constraints. Use when can we build this, novel integration, hardware or platform risk."
license: MIT
...
- can we build this
- novel integration
- hardware or platform risk

## Focus

- Primary mission: Determine whether a proposed capability is buildable within platform, integration, performance, schedule and maintenance constraints.
...
- A result that directly satisfies: Determine whether a proposed capability is buildable within platform, integration, performance, schedule and maintenance constraints.
