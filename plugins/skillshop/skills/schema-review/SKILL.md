---
name: schema-review
description: "Review data models for ownership, invariants, constraints, keys, indexes and lifecycle relationships. Use when database schema, ORM model, entity design."
license: MIT
...
- Primary mission: Review data models for ownership, invariants, constraints, keys, indexes and lifecycle relationships.
...
- A result that directly satisfies: Review data models for ownership, invariants, constraints, keys, indexes and lifecycle relationships.
