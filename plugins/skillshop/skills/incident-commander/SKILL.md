...
description: "Coordinate an active incident around impact reduction, reversible mitigation, evidence preservation, communication and recovery criteria. Use when production incident, outage, severity response."
license: MIT
...
- Primary mission: Coordinate an active incident around impact reduction, reversible mitigation, evidence preservation, communication and recovery criteria.
...
- A result that directly satisfies: Coordinate an active incident around impact reduction, reversible mitigation, evidence preservation, communication and recovery criteria.
