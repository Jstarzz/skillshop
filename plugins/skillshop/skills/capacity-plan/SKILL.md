---
name: capacity-plan
description: "Convert measured sustainable performance into headroom, failure capacity, infrastructure sizing and scaling triggers. Use when capacity planning, node sizing, traffic growth."
license: MIT
...
- Primary mission: Convert measured sustainable performance into headroom, failure capacity, infrastructure sizing and scaling triggers.
...
- A result that directly satisfies: Convert measured sustainable performance into headroom, failure capacity, infrastructure sizing and scaling triggers.
