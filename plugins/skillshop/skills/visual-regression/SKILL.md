...
description: "Detect unintended visual changes using stable screenshot baselines while separating environmental noise from real regressions. Use when visual QA, CSS changes, screenshot diff."
license: MIT
...
- Primary mission: Detect unintended visual changes using stable screenshot baselines while separating environmental noise from real regressions.
...
- A result that directly satisfies: Detect unintended visual changes using stable screenshot baselines while separating environmental noise from real regressions.
