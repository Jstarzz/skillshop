---
name: state-machine
description: "Make complex lifecycle behavior explicit as states, legal transitions, guards, side effects and invariants. Use when many status fields, workflow lifecycle, invalid state bugs."
license: MIT
...
- Primary mission: Make complex lifecycle behavior explicit as states, legal transitions, guards, side effects and invariants.
...
- A result that directly satisfies: Make complex lifecycle behavior explicit as states, legal transitions, guards, side effects and invariants.
