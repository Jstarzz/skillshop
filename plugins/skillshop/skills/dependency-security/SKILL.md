...
description: "Review dependency and supply-chain risk, advisories, provenance, update strategy and unnecessary exposure. Use when dependency CVE, supply chain, package security."
license: MIT
...
- Primary mission: Review dependency and supply-chain risk, advisories, provenance, update strategy and unnecessary exposure.
...
- A result that directly satisfies: Review dependency and supply-chain risk, advisories, provenance, update strategy and unnecessary exposure.
