...
description: "Identify technical debt that measurably slows delivery or increases defects and rank it by payoff instead of aesthetics. Use when tech debt backlog, messy codebase, cleanup planning."
license: MIT
...
- Primary mission: Identify technical debt that measurably slows delivery or increases defects and rank it by payoff instead of aesthetics.
...
- A result that directly satisfies: Identify technical debt that measurably slows delivery or increases defects and rank it by payoff instead of aesthetics.
