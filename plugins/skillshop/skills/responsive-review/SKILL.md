...
description: "Verify layouts adapt intentionally across viewport widths, text lengths, zoom and virtual keyboards instead of merely shrinking. Use when responsive UI, mobile layout, breakpoint bugs."
license: MIT
...
- Primary mission: Verify layouts adapt intentionally across viewport widths, text lengths, zoom and virtual keyboards instead of merely shrinking.
...
- A result that directly satisfies: Verify layouts adapt intentionally across viewport widths, text lengths, zoom and virtual keyboards instead of merely shrinking.
