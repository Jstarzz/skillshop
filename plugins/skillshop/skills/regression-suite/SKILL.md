...
description: "Build a compact regression suite from critical journeys and escaped defects, with a fast smoke subset. Use when regression suite, smoke tests, repeated bugs."
license: MIT
...
- Primary mission: Build a compact regression suite from critical journeys and escaped defects, with a fast smoke subset.
...
- A result that directly satisfies: Build a compact regression suite from critical journeys and escaped defects, with a fast smoke subset.
