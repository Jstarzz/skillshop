...
description: "Verify processes stop gracefully without dropping in-flight work, corrupting state or hanging deployments. Use when graceful shutdown, rolling restart, worker drain."
license: MIT
...
- Primary mission: Verify processes stop gracefully without dropping in-flight work, corrupting state or hanging deployments.
...
- A result that directly satisfies: Verify processes stop gracefully without dropping in-flight work, corrupting state or hanging deployments.
