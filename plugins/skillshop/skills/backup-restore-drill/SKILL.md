...
description: "Validate backups by restoring them into clean infrastructure and checking application-level integrity and recovery time. Use when restore drill, backup verification, disaster recovery."
license: MIT
...
- Primary mission: Validate backups by restoring them into clean infrastructure and checking application-level integrity and recovery time.
...
- A result that directly satisfies: Validate backups by restoring them into clean infrastructure and checking application-level integrity and recovery time.
