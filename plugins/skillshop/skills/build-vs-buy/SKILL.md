---
name: build-vs-buy
description: "Decide whether to build, adopt or outsource a capability using lifecycle cost, fit, lock-in and operational burden. Use when build vs buy, commodity capability, vendor evaluation."
license: MIT
...
- Primary mission: Decide whether to build, adopt or outsource a capability using lifecycle cost, fit, lock-in and operational burden.
...
- A result that directly satisfies: Decide whether to build, adopt or outsource a capability using lifecycle cost, fit, lock-in and operational burden.
