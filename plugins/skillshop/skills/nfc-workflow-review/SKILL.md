---
name: nfc-workflow-review
description: "Review NFC-based user workflows for reader/platform constraints, identity mapping, offline behavior, retries and physical failure modes. Use when NFC, badge reader, tap workflow."
license: MIT
...
- Primary mission: Review NFC-based user workflows for reader/platform constraints, identity mapping, offline behavior, retries and physical failure modes.
...
- A result that directly satisfies: Review NFC-based user workflows for reader/platform constraints, identity mapping, offline behavior, retries and physical failure modes.
