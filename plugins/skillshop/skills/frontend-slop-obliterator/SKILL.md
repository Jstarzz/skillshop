...
- Primary mission: Remove generic AI-generated UI slop and replace it with deliberate product-specific hierarchy, density, components and iconography.
...
- A result that directly satisfies: Remove generic AI-generated UI slop and replace it with deliberate product-specific hierarchy, density, components and iconography.
