---
name: copy-review
description: "Improve labels, helper text, confirmations and error messages for clarity, consistency and actionability. Use when UX copy, microcopy, error messages."
license: MIT
...
- Primary mission: Improve labels, helper text, confirmations and error messages for clarity, consistency and actionability.
...
- A result that directly satisfies: Improve labels, helper text, confirmations and error messages for clarity, consistency and actionability.
