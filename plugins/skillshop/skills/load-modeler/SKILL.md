---
name: load-modeler
description: "Translate real product usage or recorded journeys into representative arrival rates, concurrency, scenario weights, data cardinality and think time. Use when traffic model, journey to load, performance scenario design."
license: MIT
...
- Primary mission: Translate real product usage or recorded journeys into representative arrival rates, concurrency, scenario weights, data cardinality and think time.
...
- A result that directly satisfies: Translate real product usage or recorded journeys into representative arrival rates, concurrency, scenario weights, data cardinality and think time.
