...
description: "Assess whether module boundaries match domain responsibility and change patterns instead of arbitrary technical layers. Use when circular dependencies, changes touch everywhere, module boundaries."
license: MIT
...
- changes touch everywhere
- module boundaries

## Focus

- Primary mission: Assess whether module boundaries match domain responsibility and change patterns instead of arbitrary technical layers.
...
- A result that directly satisfies: Assess whether module boundaries match domain responsibility and change patterns instead of arbitrary technical layers.
