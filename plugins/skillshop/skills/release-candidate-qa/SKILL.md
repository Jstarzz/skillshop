...
description: "Run risk-based final QA against the exact release candidate and produce a go, conditional-go or no-go recommendation. Use when staging signoff, release candidate, pre-production QA."
license: MIT
...
- Primary mission: Run risk-based final QA against the exact release candidate and produce a go, conditional-go or no-go recommendation.
...
- A result that directly satisfies: Run risk-based final QA against the exact release candidate and produce a go, conditional-go or no-go recommendation.
