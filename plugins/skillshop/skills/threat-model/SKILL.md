---
name: threat-model
description: "Build a focused threat model around assets, actors, trust boundaries, attack paths and mitigations for a feature or system. Use when threat model, new sensitive system, security design."
license: MIT
...
- threat model
- new sensitive system
- security design

## Focus

- Primary mission: Build a focused threat model around assets, actors, trust boundaries, attack paths and mitigations for a feature or system.
...
- A result that directly satisfies: Build a focused threat model around assets, actors, trust boundaries, attack paths and mitigations for a feature or system.
