...
description: "Perform risk-driven application security review of changed attack surface and trust boundaries instead of dumping a generic checklist. Use when security review, public endpoint, sensitive feature."
license: MIT
...
- Primary mission: Perform risk-driven application security review of changed attack surface and trust boundaries instead of dumping a generic checklist.
...
- A result that directly satisfies: Perform risk-driven application security review of changed attack surface and trust boundaries instead of dumping a generic checklist.
