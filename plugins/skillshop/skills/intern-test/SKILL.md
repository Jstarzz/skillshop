---
name: intern-test
description: "Check whether a competent new developer can build, run, test and modify the project without tribal knowledge. Use when onboarding review, bus factor, README setup."
license: MIT
...
- Primary mission: Check whether a competent new developer can build, run, test and modify the project without tribal knowledge.
...
- A result that directly satisfies: Check whether a competent new developer can build, run, test and modify the project without tribal knowledge.
