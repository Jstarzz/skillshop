...
description: "Review Kubernetes workloads for resource requests, probes, rollout, disruption, storage, networking and failure semantics. Use when Kubernetes, k3s, deployment manifest."
license: MIT
...
- Primary mission: Review Kubernetes workloads for resource requests, probes, rollout, disruption, storage, networking and failure semantics.
...
- A result that directly satisfies: Review Kubernetes workloads for resource requests, probes, rollout, disruption, storage, networking and failure semantics.
