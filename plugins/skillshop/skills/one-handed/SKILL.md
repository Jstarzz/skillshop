---
name: one-handed
description: "Review mobile interactions for thumb reach, touch target sizing and common one-handed use. Use when mobile ergonomics, thumb reach, touch targets."
license: MIT
...
- Primary mission: Review mobile interactions for thumb reach, touch target sizing and common one-handed use.
...
- A result that directly satisfies: Review mobile interactions for thumb reach, touch target sizing and common one-handed use.
