...
description: "Review UI and data handling for locale-aware dates, numbers, currency, Unicode, text expansion and international input. Use when localization, internationalization, currency locale."
license: MIT
...
- Primary mission: Review UI and data handling for locale-aware dates, numbers, currency, Unicode, text expansion and international input.
...
- A result that directly satisfies: Review UI and data handling for locale-aware dates, numbers, currency, Unicode, text expansion and international input.
